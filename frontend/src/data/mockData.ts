...
export const mockDossiers: Record<string, PatientDossier> = {
  "PAT-1082": {
    patient_id: "PAT-1082",
    first_name: "Eleanor",
    last_name: "Vance",
...
export const mockRiskEvaluations: Record<string, RiskEvaluation> = {
  "PAT-1082": {
    patient_id: "PAT-1082",
    composite_score: 88,
    risk_level: "HIGH",
...
export const mockCardSamples: CardSample[] = [
  {
    id: "sample-bcbs",
...
export const mockDenialCategories: DenialCategoryStat[] = [
...
export const mockPayerStats: PayerDenialStat[] = [
...
export const mockPreventiveRules: PreventiveRule[] = [
  {
    id: "rule-1",
